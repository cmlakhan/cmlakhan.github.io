...
\subsection{Graduate Students}
    ...
    \begin{onecolentry}
        \textbf{Giacomo Cavalca}, New York Genome Center
    \end{onecolentry}
...
\subsection{Undergraduate Students}
    ...
    \begin{onecolentry}
        \textbf{Rohan Nidumbur}, undergraduate researcher, New York Genome Center
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Clara Yu}, undergraduate researcher, New York Genome Center (California Institute of Technology)
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Gillian Bartels-Quansah}, undergraduate researcher, New York Genome Center (Barnard College, Columbia University)
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Rolando J. Acosta Nu\~nez}, Harvard Medical School
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Shreyas Bhave}, Harvard Medical School
    \end{onecolentry}
