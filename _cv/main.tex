...
\subsection{Graduate Students}
    ...
    \begin{onecolentry}
        \textbf{Giacomo Cavalca}, research intern, New York Genome Center (University of Bologna)
    \end{onecolentry}
...
\subsection{Undergraduate Students}
    ...
    \begin{onecolentry}
        \textbf{Rohan Nidumbur}, research intern, New York Genome Center (University of Maryland, College Park)
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Gillian Bartels-Quansah}, research intern, New York Genome Center (Barnard College, Columbia University)
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Rolando J. Acosta Nu\~nez}, research intern, Harvard Medical School (University of Puerto Rico at Humacao)
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Shreyas Bhave}, research intern, Harvard Medical School (University of California, Berkeley)
    \end{onecolentry}
