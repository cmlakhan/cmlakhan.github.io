...
\section{Positions Held}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Collaborate with Gao Wang (Columbia University) on molecular QTL prediction within the ADSP Functional Genomics Consortium (FunGen-AD); work supported by NIH/NIA U01~AG068880, \textit{Learning the Regulatory Code of Alzheimer's Disease Genomes}.
                % TODO: if you are formally a co-investigator on an NIH grant with Gao Wang (2026-2027),
                % state that role explicitly here and add the grant to the Fellowships, Grants, and Awards section.
                \item Present regularly to the ADSP AI/ML Working Group and its External Advisory Board.
                \item Co-supervised Clara Yu (research intern, Caltech) on interpretable deep learning for chromatin QTL fine-mapping, resulting in a peer-reviewed conference paper (IEEE ICBCB 2026).
                % TODO: confirm the mentoring description above matches your actual role with Clara Yu.
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
               \item Advisor: Chirag J. Patel (Harvard Medical School)
                ...
                % TODO: if the Exposome Data Warehouse was publicly released as software or a resource,
                % add it to the Released Software line in Technical Skills.
...
\section{Education}
        ...
        \begin{onecolentry}
            \textbf{Additional Training:} Statistical Genetics (Alkes Price, Harvard T.H. Chan School of Public Health); Summer Institute in Statistical Genetics workshop with Peter Visscher.
            % TODO: add the years for both, and say "audited" for the Price course if you audited
            % rather than enrolled -- either is respectable, but it should say which.
        \end{onecolentry}
...
% TODO: add an "Invited Seminars" subsection here when external departmental seminar
% invitations are confirmed (e.g. a spring 2027 series).
...
\subsection{Conference Presentations}
    ...
    \begin{samepage}
        \begin{twocolentry}{
            ...
            \textbf{NIH Alzheimer's Disease Sequencing Project Annual Meeting} (Talk)
        \end{twocolentry}
    ...
    \begin{samepage}
        \begin{twocolentry}{
            ...
            \textbf{90th Cold Spring Harbor Symposium on Quantitative Biology: AI in Biology} (Poster)
        \end{twocolentry}
    ...
    \begin{samepage}
        \begin{twocolentry}{
            ...
            \textbf{Oral Abstract 325-OR} (with S.~Cromer)
        \end{twocolentry}
        ...
        \begin{onecolentry}
            ...
            % TODO: confirm the abstract title and who presented.
        \end{onecolentry}
    \end{samepage}
...
\section{Fellowships, Grants, and Awards}
    ...
    % TODO: if the NIH R21 (PI, submitted June 2026) is real, list it first, e.g.:
    % \textbf{NIH R21 (Principal Investigator)}, [title], submitted June 2026 -- under review.
    % TODO: if you are a formal co-investigator on the NIH grant with Gao Wang (2026-2027),
    % list it here with the mechanism and grant number.
...
\section{Technical Skills and Software}
    ...
    \begin{onecolentry}
        ...
        % TODO: confirm this tool list reflects what you actually use, and add/remove accordingly
        % (e.g. STAAR, MAGMA/eMAGMA, PLINK).
    \end{onecolentry}
