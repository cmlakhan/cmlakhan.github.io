...
\subsection{Undergraduate Students}
    ...
    \begin{onecolentry}
        \textbf{Rolando J. Acosta Nu\~nez}, research intern, Harvard Medical School (University of Puerto Rico at Humacao); co-mentored with Chirag J. Patel
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Shreyas Bhave}, research intern, Harvard Medical School (University of California, Berkeley); co-mentored with Chirag J. Patel
    \end{onecolentry}
