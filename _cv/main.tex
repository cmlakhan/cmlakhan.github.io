...
\section{Positions Held}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Develop deep learning methods for predicting regulatory variant effects and apply them to identify causal variants and uncover missing regulation in Alzheimer's disease, in collaboration with David Knowles (Columbia University) and Towfique Raj (Icahn School of Medicine at Mount Sinai).
                \item First author on two methods papers integrating genomic deep learning models with functional genomics: functionally informed fine-mapping of causal AD variants, and cell-type-resolved eQTL prediction (scEEMS) explaining AD heritability.
                \item Collaborate with Gao Wang (Columbia University) on molecular QTL prediction within the ADSP Functional Genomics Consortium (FunGen-AD); key personnel on NIH/NIA R01~AG086467 (\textit{FunGen-xQTL}, PI: Gao Wang) and previously on NIH/NIA U01~AG068880 (\textit{Learning the Regulatory Code of Alzheimer's Disease Genomes}).
...
\section{Education}
        ...
        \begin{onecolentry}
            \textbf{Coursework} (enrolled for credit, Harvard T.H. Chan School of Public Health): Introduction to Statistical Genetics (BST~227, Martin Aryee, Fall 2016); Molecular Biology for Epidemiologists (EPI~249, Immaculata De Vivo, Fall 2016); Advanced Population and Medical Genetics (EPI~511, Alkes Price, Spring 2017)
        \end{onecolentry}

        \vspace{0.10 cm}

        \begin{onecolentry}
            \textbf{Workshops:} 22nd Summer Institute in Statistical Genetics, University of Washington --- workshop with Peter Visscher, July 2017
        \end{onecolentry}
...
\printbibliography[keyword=preprint,heading=subbibliography,title={Preprints}]
...
\section{Fellowships, Grants, and Awards}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Key Personnel}, NIH/NIA R01~AG086467, \textit{FunGen-xQTL: Unraveling the Genetic Basis of Molecular Functions in Alzheimer's Disease} (PI: Gao Wang, Columbia University)
    \end{twocolentry}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Key Personnel}, NIH/NIA U01~AG068880, \textit{Learning the Regulatory Code of Alzheimer's Disease Genomes} (PIs: Towfique Raj and David A. Knowles)
    \end{twocolentry}
...
\subsection{Teaching}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Introduction to Data Science} --- course developed and taught at several Fortune 500 companies (Zaloni, Inc)
    \end{twocolentry}
...
\subsection{Graduate Students}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Giacomo Cavalca}, visiting PhD student, New York Genome Center (University of Bologna); co-mentored with Gao Wang (Columbia University)
    \end{twocolentry}
...
\subsection{Undergraduate Students}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Rohan Nidumbur}, research intern, New York Genome Center (University of Maryland, College Park); co-mentored with Gao Wang (Columbia University)
    \end{twocolentry}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Clara Yu}, research intern, New York Genome Center (California Institute of Technology)
    \end{twocolentry}

    \vspace{0.10 cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Interpretable deep learning for functional fine-mapping of chromatin QTLs in Alzheimer's disease; first author of a peer-reviewed conference paper (IEEE International Conference on Bioinformatics and Computational Biology, 2026).
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Gillian Bartels-Quansah}, research intern (Science Path Scholar), New York Genome Center (Barnard College, Columbia University)
    \end{twocolentry}

    \vspace{0.10 cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Deep learning prediction of RNA-binding proteins for variant-effect scoring in Alzheimer's disease association studies; first-author poster at the American Society of Human Genetics Annual Meeting, 2024.
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Rolando J. Acosta Nu\~nez}, Summer Institute in Biomedical Informatics, Harvard Medical School (University of Puerto Rico at Humacao); co-mentored with Chirag J. Patel
    \end{twocolentry}

    \vspace{0.10 cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Data engineering for the Exposome Data Warehouse, linking publicly available environmental data to electronic health records.
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Shreyas Bhave}, Summer Institute in Biomedical Informatics, Harvard Medical School (University of California, Berkeley); co-mentored with Chirag J. Patel
    \end{twocolentry}
...
\section{Technical Skills and Software}
    ...
    \begin{onecolentry}
        \textbf{Genomics:} genomic deep learning models (Enformer, ChromBPNet, DeepSEA); fine-mapping and heritability analysis (SuSiE, LDSC, MAGMA/eMAGMA); rare variant association testing (STAAR); GWAS and whole-genome sequencing analysis at ADSP scale (PLINK); single-cell genomics
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Released Software:} \hrefWithoutArrow{https://github.com/daklab/scEEMS}{scEEMS}, \hrefWithoutArrow{https://github.com/daklab/gruyere}{gruyere}, \hrefWithoutArrow{https://github.com/daklab/parmigiano}{parmigiano}, \hrefWithoutArrow{https://github.com/G2Lab/ldmat}{LDmat} (\hrefWithoutArrow{https://pypi.org/project/ldmat/}{PyPI})
    \end{onecolentry}
