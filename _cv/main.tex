...
\section{Positions Held}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Collaborate with Gao Wang (Columbia University) on molecular QTL prediction within the ADSP Functional Genomics Consortium (FunGen-AD); co-investigator on the NIH award supporting this work (2026--2027). Work also supported by NIH/NIA U01~AG068880, \textit{Learning the Regulatory Code of Alzheimer's Disease Genomes}.
...
\section{Education}
        ...
        \begin{onecolentry}
            \textbf{Additional Training:} Statistical Genetics coursework with Alkes Price, Harvard T.H. Chan School of Public Health; Summer Institute in Statistical Genetics workshop with Peter Visscher.
        \end{onecolentry}
...
\section{Fellowships, Grants, and Awards}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Co-Investigator}, NIH award for molecular QTL prediction within the ADSP Functional Genomics Consortium (with Gao Wang, Columbia University)
    \end{twocolentry}
