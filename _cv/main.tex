...
\section{Positions Held}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Co-supervised Giacomo Cavalca (graduate student) and Rohan Nidumbur (undergraduate student), whose work contributed to the scEEMS preprint, on which both are co-authors.
            \end{highlights}
        \end{onecolentry}
